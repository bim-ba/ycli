...
`ycli` wraps **231 operations across 50 resources** of the Tracker, Wiki, and Forms REST API — every one reachable from the **Python SDK** and the **CLI**, plus 221 **MCP** tools for agents.
