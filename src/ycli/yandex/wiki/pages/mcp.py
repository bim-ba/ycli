...
@mcp.tool(name="pages_get", annotations=RO, tags=TAGS)
...
@mcp.tool(name="pages_meta", annotations=RO, tags=TAGS)
...
@mcp.tool(name="pages_descendants", annotations=RO, tags=TAGS)
def descendants(
    slug: str,
    limit: int = 100,
    cursor: str = "",
