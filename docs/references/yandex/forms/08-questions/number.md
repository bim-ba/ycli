---
source: https://yandex.ru/support/forms/en/blocks-ref/number
title: "Number |"
word_count: 413
token_estimate: 727
extracted: "2026-05-22T18:04:04Z"
mode: quality
---

To answer this question, you can enter an integer or a fraction. For example, height in meters or body temperature.
...
-   To make sure that a question is pre-filled when the form is opened, click **Add default value** and enter the value.
...
-   To use a question for a test or quiz, click **Score** under **Answer**.

    -   Specify the correct answer (case-sensitive).

    -   Specify how many points users should get for answering correctly.

    For more information, see [Conducting a test](https://yandex.ru/support/forms/en/tests).
...
### Limit the number of characters in an answer

Set the minimum and maximum answer length.

### Input prompts

Enable this setting to suggest answer options from a directory as users are typing. Select the prompt type from the following groups:

-   **Organization**: Users or divisions from the organization's address book.
-   **General**: Prompt from the address directory.
-   **Personal info**: The user's email address or gender.

### Validation

The validator checks whether the answer meets the specified format. By default, validation is enabled for this question.

For more information, see [Validating an answer](https://yandex.ru/support/forms/en/option-validation).
