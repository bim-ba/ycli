---
source: https://yandex.ru/support/tracker/ru/wysiwyg/html-block
title: "Блок с HTML-разметкой - Редактировать текст |"
word_count: 678
token_estimate: 1979
extracted: "2026-05-13T10:55:23Z"
mode: quality
---

В описание задачи или комментарии можно добавить HTML-разметку с помощью специального блока. HTML-разметка позволяет создать сложную верстку: например, отчет, дизайн которого не получится реализовать стандартными элементами.

HTML-блок можно использовать вместе с другими блоками и элементами разметки.
...
HTML-блок поддерживает CSS-переменные, которые соответствуют стандартным стилям сервиса. С их помощью вы можете оформить ваш контент так же, как прочие элементы на странице. Стили, заданные с помощью CSS-переменных, будут динамически адаптироваться к смене [темы](https://yandex.ru/support/tracker/ru/wysiwyg/html-block#themes).
...
- [CSS‑переменные](https://yandex.ru/support/tracker/ru/wysiwyg/html-block#css-variables), которые уже поддерживают динамическое переключение между темами.
