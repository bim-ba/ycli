...
- [Формат запроса](https://yandex.ru/support/tracker/ru/api-ref/bulkchange/ru/api-ref/bulkchange/bulk-move-issues#query)
- [Формат ответа](https://yandex.ru/support/tracker/ru/api-ref/bulkchange/ru/api-ref/bulkchange/bulk-move-issues#answer)
...
Рабочий процесс — это набор допустимых статусов задачи и правила перехода между статусами. В каждой очереди действуют свои рабочие процессы. [Как настроить рабочий процесс](https://yandex.ru/support/tracker/ru/api-ref/bulkchange/ru/manager/workflow)
