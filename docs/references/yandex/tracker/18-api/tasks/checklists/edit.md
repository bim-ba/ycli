...
- [Формат запроса](https://yandex.ru/support/tracker/ru/api-ref/issues/ru/api-ref/issues/edit-checklist#query)
- [Формат ответа](https://yandex.ru/support/tracker/ru/api-ref/issues/ru/api-ref/issues/edit-checklist#answer)

Запрос позволяет редактировать пункты [чеклиста](https://yandex.ru/support/tracker/user/checklist.html) в задаче.
...
```
PATCH /v3/issues/<id_задачи>/checklistItems/<id_пункта_чеклиста>
...
Тело ответа содержит JSON-объект с параметрами пунктов чеклиста и параметрами задачи, в котором чеклист был изменен.
