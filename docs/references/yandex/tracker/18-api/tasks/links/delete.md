...
- [Формат запроса](https://yandex.ru/support/tracker/ru/api-ref/issues/ru/api-ref/issues/delete-link-issue#rec-format)
- [Формат ответа](https://yandex.ru/support/tracker/ru/api-ref/issues/ru/api-ref/issues/delete-link-issue#answer)
...
```
https://api.tracker.yandex.net/v3/issues/<id_задачи>/links/<id_связи>
```
...
```
DELETE /v3/issues/<id_задачи>/links/<id_связи>
...
| <id_связи> | Идентификатор связи с другой задачей. | Строка |
