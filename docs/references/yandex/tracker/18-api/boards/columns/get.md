...
- [Формат запроса](https://yandex.ru/support/tracker/ru/api-ref/boards/ru/api-ref/boards/get-column#query)
- [Формат ответа](https://yandex.ru/support/tracker/ru/api-ref/boards/ru/api-ref/boards/get-column#answer)
...
```
GET /v3/boards/<id_доски>/columns/<id_колонки>
