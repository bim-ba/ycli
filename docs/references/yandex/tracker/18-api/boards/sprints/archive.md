...
Чтобы архивировать спринт, используйте HTTP-запрос с методом `POST`:

```
POST /v3/sprints/<идентификатор_спринта>/_archive
...
| status | Статус спринта. После архивирования спринта статус изменяется на archived. | Строка |
| archived | Нахождение спринта в архиве: true — спринт находится в архиве. | Логический |
...
- [Формат запроса](https://yandex.ru/support/tracker/ru/api-ref/boards/ru/api-ref/boards/delete-sprint#query)
- [Формат ответа](https://yandex.ru/support/tracker/ru/api-ref/boards/ru/api-ref/boards/delete-sprint#answer)

Запрос позволяет удалить спринт.
