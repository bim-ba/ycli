...
- [Формат запроса](https://yandex.ru/support/tracker/ru/api-ref/boards/ru/api-ref/boards/start-sprint#query)
- [Формат ответа](https://yandex.ru/support/tracker/ru/api-ref/boards/ru/api-ref/boards/start-sprint#answer)

Запрос позволяет запустить спринт (изменить статус спринта на "в работе").

POST

```
https://api.tracker.yandex.net/v3/sprints/<идентификатор_спринта>/_start
```

## Формат запроса

Чтобы запустить спринт, используйте HTTP-запрос с методом `POST`:

```
POST /v3/sprints/<идентификатор_спринта>/_start
...
| status | Статус спринта. После запуска спринта статус изменяется на in_progress. | Строка |
...
- [Формат запроса](https://yandex.ru/support/tracker/ru/api-ref/boards/ru/api-ref/boards/archive-sprint#query)
- [Формат ответа](https://yandex.ru/support/tracker/ru/api-ref/boards/ru/api-ref/boards/archive-sprint#answer)

Запрос позволяет переместить спринт в архив.

POST

```
https://api.tracker.yandex.net/v3/sprints/<идентификатор_спринта>/_archive
```
