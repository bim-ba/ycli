...
- [Формат запроса](https://yandex.ru/support/tracker/ru/api-ref/boards/ru/api-ref/boards/get-sprint#query)
- [Формат ответа](https://yandex.ru/support/tracker/ru/api-ref/boards/ru/api-ref/boards/get-sprint#answer)
...
```
GET /v3/sprints/<идентификатор_спринта>
