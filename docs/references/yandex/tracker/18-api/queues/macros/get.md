...
- [Формат запроса](https://yandex.ru/support/tracker/ru/api-ref/ru/api-ref/get-macros#query)
- [Формат ответа](https://yandex.ru/support/tracker/ru/api-ref/ru/api-ref/get-macros#answer)

Запрос позволяет получить параметры макроса. [Что такое макрос](https://yandex.ru/support/tracker/manager/create-macroses.html)
...
```
GET /v3/queues/<id_очереди>/macros/<id_макроса>
...
- [Формат запроса](https://yandex.ru/support/tracker/ru/api-ref/ru/api-ref/post-macros#query)
- [Формат ответа](https://yandex.ru/support/tracker/ru/api-ref/ru/api-ref/post-macros#answer)

Запрос позволяет создать макрос. [Что такое макрос](https://yandex.ru/support/tracker/manager/create-macroses.html)
