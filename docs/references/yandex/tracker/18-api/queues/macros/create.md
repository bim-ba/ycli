...
```
POST /v3/queues/<id_очереди>/macros
...
| Параметр | Описание | Тип данных |
| --- | --- | --- |
| body | Сообщение, которое будет создано при выполнении макроса. Для оформления текста сообщения используйте правила форматирования.Чтобы удалить сообщение, используйте конструкцию "body": {"unset":1} | Строка |
