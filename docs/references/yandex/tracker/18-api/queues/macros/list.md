...
- [Формат запроса](https://yandex.ru/support/tracker/ru/api-ref/ru/api-ref/get-macroses#query)
- [Формат ответа](https://yandex.ru/support/tracker/ru/api-ref/ru/api-ref/get-macroses#answer)

Запрос позволяет получить параметры всех макросов очереди. [Что такое макрос](https://yandex.ru/support/tracker/manager/create-macroses.html)
