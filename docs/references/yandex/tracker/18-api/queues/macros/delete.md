...
- [Формат запроса](https://yandex.ru/support/tracker/ru/api-ref/ru/api-ref/delete-macros#query)
- [Формат ответа](https://yandex.ru/support/tracker/ru/api-ref/ru/api-ref/delete-macros#answer)
...
```
DELETE /v3/queues/<id_очереди>/macros/<id_макроса>
