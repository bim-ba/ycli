...
- [Формат запроса](https://yandex.ru/support/tracker/ru/api-ref/issues/ru/api-ref/issues/create-issue-field-category#query)
- [Формат ответа](https://yandex.ru/support/tracker/ru/api-ref/issues/ru/api-ref/issues/create-issue-field-category#answer)
...
Чтобы создать категорию для поля задачи используйте HTTP-запрос с методом `POST`. В теле запроса укажите параметры в формате JSON:
