...
- [Формат запроса](https://yandex.ru/support/tracker/ru/api-ref/queues/ru/api-ref/queues/create-local-field#query)
- [Формат ответа](https://yandex.ru/support/tracker/ru/api-ref/queues/ru/api-ref/queues/create-local-field#answer)

Запрос позволяет создать [локальное поле](https://yandex.ru/support/tracker/local-fields.html) задачи, привязанное к заданной очереди.
