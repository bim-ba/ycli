...
- [Формат запроса](https://yandex.ru/support/tracker/ru/api-ref/queues/ru/api-ref/queues/get-info-local-field#query)
- [Формат ответа](https://yandex.ru/support/tracker/ru/api-ref/queues/ru/api-ref/queues/get-info-local-field#answer)

Запрос позволяет получить информацию о [локальном поле](https://yandex.ru/support/tracker/local-fields.html) задачи, привязанном к заданной очереди.
...
```
GET /v3/queues/<id_очереди>/localFields/<ключ_поля>
