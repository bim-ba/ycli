...
- [Формат запроса](https://yandex.ru/support/tracker/ru/api-ref/projects/ru/api-ref/projects/get-project#query)
- [Формат ответа](https://yandex.ru/support/tracker/ru/api-ref/projects/ru/api-ref/projects/get-project#answer)
...
Вы также можете использовать новый, более гибкий и функциональный API [получения информации о сущности](https://yandex.ru/support/tracker/ru/api-ref/projects/ru/api-ref/entities/get-entity), представляющий унифицированный метод получения информации о проектах и портфелях.
