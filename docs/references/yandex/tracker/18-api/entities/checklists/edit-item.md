...
- [Формат запроса](https://yandex.ru/support/tracker/ru/api-ref/entities/checklists/ru/api-ref/entities/checklists/patch-checklist-item#query)
- [Формат ответа](https://yandex.ru/support/tracker/ru/api-ref/entities/checklists/ru/api-ref/entities/checklists/patch-checklist-item#answer)

Запрос позволяет обновить информацию об отдельном пункте чеклиста в проектах и портфелях. [Как использовать чеклисты](https://yandex.ru/support/tracker/user/checklist.html).
...
Чтобы изменить пункт в чеклисте, используйте HTTP-запрос с методом `PATCH`. В теле запроса укажите параметры в формате JSON.

```
PATCH /v3/entities/<тип_сущности>/<id_сущности>/checklistItems/<id_пункта_чеклиста>
...
>  
> ```
> PATCH /v3/entities/project/<id_проекта>/checklistItems/<id_пункта_чеклиста>?fields=checklistItems
> Host: api.tracker.yandex.net
