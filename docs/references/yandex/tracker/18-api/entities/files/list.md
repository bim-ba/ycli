...
- [Формат запроса](https://yandex.ru/support/tracker/ru/api-ref/entities/attachments/ru/api-ref/entities/attachments/get-all-attachments#query)
- [Формат ответа](https://yandex.ru/support/tracker/ru/api-ref/entities/attachments/ru/api-ref/entities/attachments/get-all-attachments#answer)

Запрос позволяет получить список файлов, прикрепленных к [сущности](https://yandex.ru/support/tracker/ru/api-ref/entities/attachments/ru/api-ref/entities/about-entities).

GET

```
https://api.tracker.yandex.net/v3/entities/<тип_сущности>/<id_сущности>/attachments
```
...
```
GET /v3/entities/<тип_сущности>/<id_сущности>/attachments
...
>  
> ```
> GET https://api.tracker.yandex.net/v3/entities/project/<id_проекта>/attachments
> ```
