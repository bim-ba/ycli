...
- `slug` — ненормализованный slug страницы, например users/something/abc
- `fields` — желаемые дополнительные блоки, через запятую; см. описание формата ответа
- `raise_on_redirect` — если на странице установлен редирект, будет выведена ошибка
...
- [Request](https://yandex.ru/support/wiki/ru/api-ref/pages/ru/api-ref/pages/pages__create_page#request)
  - [Query parameters](https://yandex.ru/support/wiki/ru/api-ref/pages/ru/api-ref/pages/pages__create_page#query-parameters)
  - [Body](https://yandex.ru/support/wiki/ru/api-ref/pages/ru/api-ref/pages/pages__create_page#body)
- [Responses](https://yandex.ru/support/wiki/ru/api-ref/pages/ru/api-ref/pages/pages__create_page#responses)
- [200 OK](https://yandex.ru/support/wiki/ru/api-ref/pages/ru/api-ref/pages/pages__create_page#200-ok)
  - [Body](https://yandex.ru/support/wiki/ru/api-ref/pages/ru/api-ref/pages/pages__create_page#body1)
  - [PageType](https://yandex.ru/support/wiki/ru/api-ref/pages/ru/api-ref/pages/pages__create_page#entity-PageType)
  - [PageDetailsSchema](https://yandex.ru/support/wiki/ru/api-ref/pages/ru/api-ref/pages/pages__create_page#entity-PageDetailsSchema)
  - [RedirectSchema](https://yandex.ru/support/wiki/ru/api-ref/pages/ru/api-ref/pages/pages__create_page#entity-RedirectSchema)
  - [BreadcrumbSchema](https://yandex.ru/support/wiki/ru/api-ref/pages/ru/api-ref/pages/pages__create_page#entity-BreadcrumbSchema)
  - [PageAttributesSchema](https://yandex.ru/support/wiki/ru/api-ref/pages/ru/api-ref/pages/pages__create_page#entity-PageAttributesSchema)
